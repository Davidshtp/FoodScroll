...
; new-tab --tabColor "#ADFF2F" --suppressApplicationTitle --title "Orders Service" cmd /k "cd /d C:\Users\pc\OneDrive\Desktop\proyecto\foodscroll\orders-service && npm run start:dev" ^
