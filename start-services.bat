...
:: Definimos la ruta base sin comillas aquí
set "BASE_DIR=C:\Users\User hp\Documents\ITP\7MO SEMESTRE\Proyecto\FoodScroll"

:: Ejecutamos Windows Terminal envolviendo la ruta de la aplicación entre comillas directamente
"C:\Users\User hp\AppData\Local\Microsoft\WindowsApps\wt.exe" ^
new-tab --tabColor "#00AAFF" --suppressApplicationTitle --title "Gateway" cmd /k "cd /d \"%BASE_DIR%\gateway\" && npm run start" ^
